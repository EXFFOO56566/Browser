...
package com.tochy.tochybrowser.browser.tab;
...
import com.tochy.tochybrowser.core.utility.utils.ArrayUtils;
...
import com.tochy.tochybrowser.legacy.tab.manager.TabCache;
import com.tochy.tochybrowser.legacy.tab.manager.TabFaviconManager;
import com.tochy.tochybrowser.legacy.tab.manager.TabIndexData;
import com.tochy.tochybrowser.legacy.tab.manager.TabManager;
import com.tochy.tochybrowser.legacy.tab.manager.TabStorage;
import com.tochy.tochybrowser.legacy.tab.manager.ThumbnailManager;
...
public class CacheTabManager implements TabManager, TabCache.OnCacheOverFlowListener<MainTabData> {
    ...
    private void setIcon(View view, TabIndexData indexData) {
        if (indexData.getOriginalUrl() == null || indexData.getOriginalUrl().startsWith("https://www.google.com/")) {
            return;
        }
