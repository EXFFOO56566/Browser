...
import com.tochy.tochybrowser.core.utility.extensions.binarySearch
import com.tochy.tochybrowser.core.utility.extensions.toSortedList
import java.io.File

val externalUserDirectory: File
    get() = File(Environment.getExternalStorageDirectory().toString() + File.separator + "OXBrowser" + File.separator)
