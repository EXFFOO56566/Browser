...
class PasteSearchBoxAction : SingleAction, Parcelable {
    ...
    companion object {
        ...
        @JvmField
        val CREATOR: Parcelable.Creator<PasteSearchBoxAction> = object : Parcelable.Creator<PasteSearchBoxAction> {
            override fun createFromParcel(source: Parcel): PasteSearchBoxAction {
                return PasteSearchBoxAction(source)
            }

            override fun newArray(size: Int): Array<PasteSearchBoxAction?> {
