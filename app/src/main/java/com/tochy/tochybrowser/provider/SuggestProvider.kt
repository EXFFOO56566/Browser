...
package com.tochy.tochybrowser.provider
...
import com.tochy.tochybrowser.BuildConfig
import com.tochy.tochybrowser.ErrorReportServer
import com.tochy.tochybrowser.core.utility.log.Logger
import com.tochy.tochybrowser.search.model.SearchSuggestModel
import com.tochy.tochybrowser.search.model.suggest.ISuggest
import com.tochy.tochybrowser.search.model.suggest.SuggestBing
import com.tochy.tochybrowser.search.model.suggest.SuggestDuckDuckGo
import com.tochy.tochybrowser.search.model.suggest.SuggestGoogle
...
class SuggestProvider : DaggerContentProvider() {
    ...
    companion object {
        ...
        private val yuzuPrefix = arrayOf("ox:bookmarks", "ox:debug", "ox:downloads", "ox:history", "ox:home", "ox:readItLater", "ox:resBlock", "ox:settings", "ox:speeddial")
